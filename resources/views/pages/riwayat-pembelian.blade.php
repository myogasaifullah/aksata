...
<div class="max-w-6xl mx-auto py-8 px-4">
    <!-- Header Section -->
    <div class="mb-6">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Cari Transaksi</h1>
        <p class="text-gray-600 mt-1">Masukkan ID Transaksi untuk melihat detail pembelian Anda</p>
    </div>

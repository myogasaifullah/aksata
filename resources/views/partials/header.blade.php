    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <nav class="hidden md:flex space-x-8 items-center">
                ...
                <a href="https://wa.me/6282276993219" target="_blank" class="ml-4 flex items-center px-3 py-2 bg-green-500 hover:bg-green-600 text-white text-sm font-medium rounded-full shadow-md transition-all duration-300">
